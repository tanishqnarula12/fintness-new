        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 xl:gap-24 items-center">
          ...
          >
            ...
            >
              ...
              <h4 className="text-4xl font-black text-[#1a1a2e] tracking-tighter mb-1">14+</h4>
          ...
          <div className="flex flex-col items-start text-left lg:py-10">
            ...
            >
              <a href="https://www.linkedin.com/in/nitesh-luthra-b4934124?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="flex items-center justify-center w-10 h-10 rounded-full border border-white/10 text-white/50 hover:text-[#0066FF] hover:border-[#0066FF] hover:bg-[#0066FF]/10 transition-all duration-300">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>
              </a>
              <a href="https://x.com/NITESHLUTH44019" target="_blank" rel="noopener noreferrer" aria-label="Twitter (X)" className="flex items-center justify-center w-10 h-10 rounded-full border border-white/10 text-white/50 hover:text-[#00B2FF] hover:border-[#00B2FF] hover:bg-[#00B2FF]/10 transition-all duration-300">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"></path></svg>
              </a>
              <a href="https://www.instagram.com/nitesh_luthra?utm_source=qr&igsh=MWp1eGkyczg5dnRzNA==" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="flex items-center justify-center w-10 h-10 rounded-full border border-white/10 text-white/50 hover:text-[#E4405F] hover:border-[#E4405F] hover:bg-[#E4405F]/10 transition-all duration-300">
