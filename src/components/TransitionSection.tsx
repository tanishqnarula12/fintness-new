...
export default function TransitionSection() {
  return (
    <section className="relative w-full py-8 px-6">
      ...
      >
        <p className="text-xl md:text-2xl lg:text-3xl text-[#1a1a2e]/50 font-extralight tracking-wide leading-relaxed">
          Now that you&apos;ve broken old habits…
        </p>
        <p className="text-2xl md:text-3xl lg:text-4xl text-[#1a1a2e] font-medium mt-3 tracking-tight">
