    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          ...
          <button className="bg-gradient-to-r from-[#0066FF] to-[#00B2FF] text-white px-5 py-2.5 rounded-full font-bold text-sm tracking-wide hover:scale-105 transition-all duration-300 hover:shadow-md">
            Get Started
          </button>
        </div>
