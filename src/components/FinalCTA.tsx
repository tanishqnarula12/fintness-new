    ...
    <section className="relative py-20 md:py-32 lg:py-40 px-6 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          ...
          <Link href="/services" className="text-[#1a1a2e]/80 hover:text-[#1a1a2e] font-medium tracking-wide py-4 px-8 rounded-full text-lg transition-all duration-300 border border-[#1a1a2e]/30 hover:border-[#1a1a2e]/50 hover:bg-[#1a1a2e]/[0.05] inline-block text-center">
            Learn More
          </Link>
        </motion.div>
      </div>
