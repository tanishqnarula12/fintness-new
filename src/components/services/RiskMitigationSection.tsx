...
import { Shield, Activity, Umbrella, AlertTriangle, LifeBuoy, HeartPulse } from "lucide-react";
            ...
            <div className="bg-indigo-50/50 rounded-2xl p-8 border border-indigo-100 shadow-sm">
              ...
              <ul className="space-y-4">
                {features.map((feature, idx) => (
                  <li key={idx} className="flex items-center bg-white p-3 rounded-lg border border-indigo-50 shadow-sm">
                    <div className="bg-indigo-50 p-2 rounded-md mr-4 shrink-0">
                      {feature.icon}
                    </div>
